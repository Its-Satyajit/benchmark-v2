...
// Desktop Application Main/Renderer IPC Replay Simulation
function runDesktopBenchmark() {
  ...
  // Cross-Platform Desktop state dispatch & replay loop
  const result = simulateReplay(data, 'tauri-electron-desktop');
